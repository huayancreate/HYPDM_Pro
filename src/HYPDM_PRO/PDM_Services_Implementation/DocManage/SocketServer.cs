...
        private Thread TempThread;
    ...
    public class Client
    {
        ...
        public Client( string ip, int port,string filename,string realfilename)
        {
        ...
        {
            //创建一个文件对象  
            FileInfo EzoneFile = new FileInfo(realfilename);
            //打开文件流  
            ...
            //发送[文件名]到客户端  
            TransferFiles.SendVarData(client, System.Text.Encoding.Unicode.GetBytes(filename));
            //发送[包的大小]到客户端  
